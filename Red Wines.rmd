...
mean is around .7 or so. This will also be interesting in the multivariate
...
here that the mean is around 0.25, and this is not a normal histogram at all,
...
associated with red wine quality. Here, we can see the mean is around 0.5 .
...
acidity and positively correlated with volatile acidity. Acidity in general
...
When I mapped variables such as alcohol content, residual sugar, and citric acid 
vs. quality, I do not know how to read these
charts. I think there was an issue because quality is an integer. However, we
will look at these charts again in the section on multivariate analysis.
...
sugar seemed to decrease. It is unclear to me how citric acid affects quality
from the scatterplot. I will do all three of these again as a multivariate
analysis.
...
sulfates, we notice the same trend - more sulfates means a higher-quality wine.
...
We can see here that a higher mean of residual sugar is associated with
